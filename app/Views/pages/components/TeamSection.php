<section class='teams-section'>
  ...
  <p>En <span>SNACKERS</span>, creemos en el poder del equipo. Conoce a los corazones y mentes detrás de nuestra pasión por el calzado, dedicados a brindarte una experiencia excepcional en cada paso del camino.</p>
  <div class='team-cards'>
    <article class='card'>
      <div class='card-img'>
        <img src='<?= base_url() ?>assets/img/team/1.jfif'>
      </div>
      <div class='card-body'>
    ...
    <article class='card'>
      <div class='card-img'>
        <img src='<?= base_url() ?>assets/img/team/2.jfif'>
      </div>
      <div class='card-body'>
        <h4>Sofía López</h4>
    ...
    <article class='card'>
      <div class='card-img'>
        <img src='<?= base_url() ?>assets/img/team/3.jfif'>
      </div>
      <div class='card-body'>
    ...
    <article class='card'>
      <div class='card-img'>
        <img src='<?= base_url() ?>assets/img/team/4.jfif'>
      </div>
      <div class='card-body'>
        <h4>Lucas García</h4>
